...
## Usage
 ...
 you can also download data from here <a href=''>data to train bert for AI challenger-Sentiment Analysis</a>.
  
 it contain processed data you can run for sentiment analysis and pre-train bert. 
